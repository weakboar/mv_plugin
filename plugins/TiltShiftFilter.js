...
/*!
 * Compiled by pixi-filters - v1.0.6
 * Compiled Mon, 08 May 2017 15:11:11 UTC
 *
...
TiltShiftFilter.prototype.apply = function (filterManager, input, output)
{
    ...
    this.tiltShiftXFilter.texSize = new PIXI.Point(renderTarget.size.width, renderTarget.size.height);
    this.tiltShiftYFilter.texSize = new PIXI.Point(renderTarget.size.width, renderTarget.size.height);

    this.tiltShiftXFilter.apply(filterManager, input, renderTarget, true);

    this.tiltShiftYFilter.apply(filterManager, renderTarget, output, false);
